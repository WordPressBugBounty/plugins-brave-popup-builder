...
function brave_signupUser(event, elementID, popupID, stepIndex){
   ...
   var signupNewsletter = document.getElementById('brave_signup_newsletter_'+elementID) ? document.getElementById('brave_signup_newsletter_'+elementID).checked : false;
   ...
   var newUserData = { username: username || false, email: userEmail, signupsecurity: security, firstname: userFirstname, lastname: userLastname, elementID: elementID, popupID: popupID, signupNewsletter: signupNewsletter, stepIndex: stepIndex, redirect: redirectURL, action: 'bravepop_ajax_signup' };
